...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/DARK.SOUL.3030')
...
def approval():
  ...
  try:
    ...
    httpCaht = requests.get("https://github.com/Usmaniyas/Approve.txt/blob/main/Approve.txt").text
...
def menu(my_name,my_id):
	...
	if Meledak in ['1']:
		...
		os.system('https://github.com/Usmaniyas/total.git')
...
def passu():
	...
	prog = Progress(TextColumn('\033[1;97m [MAHENDRA]{task.description}'))
	...
	print(' [\u001b[36m•\033[1;37m] THANKS FOR USING OUR TOOL ')
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\u001b[33m [MAHENDRA-CP] {idf}  {pw}\033[1;97m')
				...
				print(f'\033[1;32m [MAHENDRA-OK] {idf}  {pw}\033[1;97m')
